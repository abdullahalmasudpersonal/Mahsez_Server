...
const initPayment = (paymentData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = {
            ...
            success_url: `${config_1.default.backend_url}/payment/success?tran_id=${paymentData === null || paymentData === void 0 ? void 0 : paymentData.transactionId}&amount=${paymentData === null || paymentData === void 0 ? void 0 : paymentData.amount}`,
